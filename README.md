...
This project is fully documented from an architectural standpoint. If you are reviewing the code or looking at the advanced mechanics beneath the full-stack loop, read the dedicated chapters:

- **[Architecture & Lifecycles](./docs/01_architecture.md)** — Analysis of IoC stereotypes and startup hooks.
- **[ORM Traps & Relationship Graphs](./docs/02_data_relations.md)** — Circular serialization solutions and performance fetching.
- **[The Simulation Engine](./docs/03_simulation_engine.md)** — Comprehensive breakdown of the deterministic math loops and real-time stream layout.
